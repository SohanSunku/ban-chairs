...
const Index = () => {
  ...
  const pressArticles = [{
    ...
    excerpt: "Furniture giant faces backlash after internal memo surfaces in response to chronic pain chrisis 'we're NOT teaching people how to sit, we work with how they already sit'"
  }];
